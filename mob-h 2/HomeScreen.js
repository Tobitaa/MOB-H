  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.box}>
        <Text>
          <Text style={styles.negrita}>⚠️ATENCIÓN⚠️:</Text> Esta aplicacion está
          hecha para los amantes de los completos.
        </Text>
        ...
        />
        <Text>
          ¿Qué quieres ver hoy acerca de tu relación con los completos?{' '}
        </Text>
        <Text style={styles.espacio}> </Text>
        <Button title="Ir a" onPress={irHola} />
      </View>
      <View>
        <Text style={styles.mensaje}>Hecho con 💜 y completos</Text>
      </View>
    </SafeAreaView>
  );
};
...
const styles = StyleSheet.create({
  ...
  box: {
    ...
    shadowColor: '#000',
    shadowOffset: {
      //Esto le agrega como una sombrita al cuadrado
      width: 0,
      height: 5,
    },
    shadowOpacity: 0.25,
